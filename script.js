...
const STOPS_COORDS = {
  ...
  'KK Sentral': { lat: 5.9804, lng: 116.0735 }, // Example coordinate
  'Jabatan Audit': { lat: null, lng: null },
  'Monocolo Boutique Hotel': { lat: null, lng: null },
  'Sawit Kinabalu': { lat: null, lng: null },
  'Wisma Wanita': { lat: null, lng: null },
  'Taman Yakim Jaya': { lat: null, lng: null },
  'Basel Likas': { lat: null, lng: null },
  'SM Shan Tao': { lat: null, lng: null },
  'OPP SDA Likas': { lat: null, lng: null },
  'Wisma Kosan': { lat: null, lng: null },
  'Likas Plaza': { lat: null, lng: null },
  'OPP Pintu Masjid Bandaraya': { lat: null, lng: null },
  'Masjid Bandaraya': { lat: null, lng: null },
  'McD Anjung Selera': { lat: null, lng: null },
  'Anjung Selera': { lat: null, lng: null },
  'Menara Kinabalu': { lat: null, lng: null },
  'Innoprise': { lat: null, lng: null },
  'KPKPS': { lat: null, lng: null },
  'UMS': { lat: null, lng: null },
  '1 Borneo': { lat: null, lng: null },
  'Kg. Delima': { lat: null, lng: null },
  'Alamesra I': { lat: null, lng: null },
  'OPP 1 Borneo': { lat: null, lng: null },
  'Alamesra II': { lat: null, lng: null },
  'OPP KPKPS': { lat: null, lng: null },
  'OPP Innoprise': { lat: null, lng: null },
  'Pintu Masjid Bandaraya': { lat: null, lng: null },
  'Shell Likas': { lat: null, lng: null },
  'Kg. Cendrakasih': { lat: null, lng: null },
  'Luyang Plaza': { lat: null, lng: null },
  'Foh Sang': { lat: null, lng: null },
  'Bornion': { lat: null, lng: null },
  'Taman Layang-Layang': { lat: null, lng: null },
  'Zirafah': { lat: null, lng: null },
  'OPP Mahkamah': { lat: null, lng: null },
  'OPP Jabatan Audit': { lat: null, lng: null },
  
  // S05 Stops - Add coordinates here
  'Centre Point': { lat: null, lng: null },
  'Segama': { lat: null, lng: null },
  'Jesselton Mall': { lat: null, lng: null },
  'Jesselton Point Ferry Terminal': { lat: null, lng: null },
  'Jesselton Quay': { lat: null, lng: null },
  'SICC': { lat: null, lng: null },
  'Sabah Energy': { lat: null, lng: null },
  'Sabah Trade Centre': { lat: null, lng: null },
  'Kompleks Sukan Likas': { lat: null, lng: null },
  'Stadium Hoki': { lat: null, lng: null },
  'KPJ': { lat: null, lng: null },
  'HQE 2': { lat: null, lng: null },
  'Damai Plaza': { lat: null, lng: null },
  'E-West': { lat: null, lng: null },
  'Taman Kinabalu': { lat: null, lng: null },
  'Lido': { lat: null, lng: null },
  'Taman Fortuna': { lat: null, lng: null },
  'Vetro 11': { lat: null, lng: null },
  'HQE 1': { lat: null, lng: null },
  'Masjid Negeri': { lat: null, lng: null },
  'UTC': { lat: null, lng: null },
  'Sacred Heart': { lat: null, lng: null },
  'Sadong Jaya': { lat: null, lng: null }
};
